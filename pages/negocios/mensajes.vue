<template>
  ...
  <v-container fluid :fill-height="chat_pool.length === 0">
      ...
      <v-list>
        ...
        >
          ...
          >
            ...
            <v-list-item-avatar class="ml-n9 mr-2">
              <v-img :src="usuarios && usuarios[chat.usuario].image !== '' ?
              usuarios[chat.usuario].image :
              'https://www.timandorra.com/wp-content/uploads/2016/11/Imagen-no-disponible-282x300.png'"
              />
            </v-list-item-avatar>
            <v-list-item-content>
              <v-list-item-title>
                <h4>
                  ...
                  {{ usuarios ? usuarios[chat.usuario].nombre : '' }}
                </h4>
                <v-spacer />
                <span>
                  {{
    ...
    >
      ...
      <v-avatar size="50" v-if="chat_pool && chat_pool.length > 0" class="ml-n6 mr-2">
      ...
      >
        ...
        <v-col cols="10" xl="4" lg="4" md="6" sm="8" xs="8">
          ...
          >
            ...
            <v-list-item exact class="ma-2" inactive>
        ...
        <v-col cols="12">
          ...
          <v-layout justify-center>
            <div class="subtitle justify-text" style="font-size: 18px;">
              Aún no han iniciado conversación con alguno de tus negocios
            </div>
          </v-layout>
          ...
          chatKeys.forEach(chatKey => {
            ...
            if(chatKey === uc){
              ...
              Object.keys(temporal).forEach( chatItemKey => {
                ...
                if(temporal[chatItemKey].negocio === this.idAuth){
