                    ...
                    <v-window-item :value="1">
                      ...
                      <v-card-text class="pa-4">
                        ...
                        <v-form ref="formDatosNegocio">
                          ...
                          <h3 class="black--text mb-4">Selecciona lo que mejor describa la clase de turismo que realizas</h3>
    ...
    data() {
      ...
      return {
        ...
        lista_tags: [
          ...
          {
            text: 'Turismo sanitario',
            color: 'red',
          },
          {
            text: 'Turismo cultural',
            color: 'indigo',
          },
          {
            text: 'Turismo individual',
            color: 'teal',
          },
          {
            text: 'Turismo científico',
            color: 'yellow',
          },
          {
            text: 'Turismo individual',
