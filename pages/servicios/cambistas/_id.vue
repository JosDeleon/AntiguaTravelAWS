            ...
            <v-list-item-title>
              <v-row class="py-4 pl-2">
                ...
                <div class="grey--text mt-1 ml-1">
                  {{ cambista.totalValoraciones }} valoraciones |
    ...
    <v-slide-group show-arrows class="hidden-sm-and-down pa-9" ref="slideGroup">
      ...
      <div v-for="(image, i) in galeria" :key="i">
        ...
        <v-slide-item>
          ...
          <v-img class="ma-1" :src="image" @click="index = i" min-height="400" min-width="400" max-width="500" max-height="400" style="border-radius:10px;">
      ...
      <v-col cols="12">
        ...
        >
          ...
          <v-card-text class="pa-4">
            ...
            >
              Lo sentimos, este cambista aún no cuenta con productos o servicios
            </v-alert>
      ...
      <v-col cols="12">
        ...
        >
          ...
          <v-card-text class="pa-4">
            ...
            >
              Lo sentimos, este cambista aún no cuenta con reseñas
            </v-alert>
...
export default {
  ...
  methods: {
    ...
    async ObtenerValoraciones(){
      ...
      this.cambista.totalValoraciones = this.valoraciones.length
      this.cambista.puntuacionAvg = (this.valoraciones.length > 0) ? valoracionesAvg / this.valoraciones.length : 0
      this.$forceUpdate()
